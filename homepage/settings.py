...
ALLOWED_HOSTS = ['shpark.herokuapp.com','www.sunghopark.com','sunghopark.com']
...
SECRET_KEY = '-ks!b4$m3b8bi!i2w*p-l&y#t83$vl9k@jvaal^zf66ywl6+94'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
	#'C:/users/lonelycube/homepage/templates',
